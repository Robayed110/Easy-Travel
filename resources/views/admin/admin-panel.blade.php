    ...
    <div>
        <div>
            <nav class="nav1">
                ...
                <ul>
                    <li><a href="{{url('/show-data')}}">Bus Schedule</a></li>
                    <li><a href="{{url('/show-user')}}">Customer Info</a></li>
                    <li><a href="{{url('show-booked')}}">Booked-Ticket</a></li>
        ...
        <div class="container">
            <p class="my-3" style="font-weight: 700;color: white;font-size: large;">Customer Information Details:</p>
        ...
        <div class="container">
            <p class="my-3" style="font-weight: 700;color: white;font-size: large;">Bus Schedule Details:</p>
            <table class="table table-bordered" style="background-color: rgba(255, 255, 255, 0.5);">
                <thead>
                    <tr>
                        <th scope="col">#</th>
